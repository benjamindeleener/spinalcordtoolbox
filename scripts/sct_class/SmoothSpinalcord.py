...
# Authors: Simon Levy, Olivier Comtois
# Modified: 2014-09-01
#
    ...
    def execute(self):
        ...
        try:
           ...
           # Straighten the spinal cord
            ...
            ApplyTransfo(input_image=anat_rpi_straight_smooth.nii, output_filename=anat.nii, warp=warp_straight2curve.nii.gz,verbose=self.verbose)
        except Exception, e:
            pass
