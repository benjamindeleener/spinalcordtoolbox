...
def main():
    ...
    parser.usage.set_description('crop the image in order to keep only voxels in the mask, therefore the mask\'s\
    ...
    parser.add_option("-output", "file", "output file name", False, "t2_segin_smartlycropped.nii.gz")
    ...
    if fname_out == '':
        fname_out = input_img.file + '_smartly_cropped'
